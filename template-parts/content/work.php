<div id="work_container" class="container portfolio">
    ...
    <section>
        <div class="flex">
            ...
            <div class="self-center">
                ...
                <h3>Designed and Built by <a class="link-work" href="https://chaptr.studio/" target="_blank">Chaptr</a></h3><br>
    ...
    <section>
        <div class="flex">
            <div class="self-center">
                <img class="portfolio-img" src="<?php echo get_stylesheet_directory_uri(); ?>/images/2025-portfolio.jpg">
            </div>
            <div class="self-center">
                <h2>Southampton 2025</h2>
                <h3>Designed and Built by <a class="link-work" href="https://southampton2025.co.uk/" target="_blank">Chaptr</a></h3><br>
    ...
    <section>
        <div class="flex">
            ...
            <div class="self-center">
                <h2>Ball Roofing & Property</h2><br>   
    ...
    <section>
        <div class="flex">
            <div class="self-center">
                <img class="portfolio-img" src="<?php echo get_stylesheet_directory_uri(); ?>/images/bridge2aid-portfolio.jpg">
            </div>
            <div class="self-center">
                <h2>Bridge 2 Aid</h2>
                <h3>Designed and Built by <a class="link-work" href="https://dental-design.marketing/" target="_blank">Dental Design Marketing</a></h3><br>
